...
def _make_cube(x, y, data, aux=None, offset=0, scalar=None):
    ...
    cube_data = numpy.empty((y_size, x_size), dtype=numpy.float32)
    cube_data[:] = data
...
class TestSimple(tests.IrisTest):
    ...
    def test_single(self):
        ...
        cubes = iris.load_cubes(filename)
    ...
    def test_multi_equal(self):
        ...
        expected = [cubes[0], cubes[0]]
        self.assertEqual(concatenate(cubes), expected)
...
class Test2D(tests.IrisTest):
    ...
    def test_concat_2x2d_aux_xy_bounds(self):
        ...
        coord.bounds = numpy.array([1, 2, 3, 4,
                                    101, 102, 103, 104,
                                    201, 202, 203, 204,
        ...
        coord = cube.coord('xy-aux')
        coord.bounds = numpy.array([2, 3, 4, 5,
                                    102, 103, 104, 105,
                                    202, 203, 204, 205,
