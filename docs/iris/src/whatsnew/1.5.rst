...
* Cubes now have a dictionary for CF global metadata called
  :attr:`iris.cube.Cube.global_attributes`. Some of the metadata in this dictionary
  may have previously been stored in :attr:`iris.cube.Cube.attributes`. As part of
  this change the signature of Cube constructor (:meth:`iris.cube.Cube.__init__`)
  now has an additional `global_attributes` keyword argument.
